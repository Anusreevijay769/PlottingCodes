...
//{ "FatJet_pt",             200, 1200, 20, 3,          "FatJet p_{T} (GeV/c)",     "FatJet_pt",       200,  1200, 20, 1 },
 // { "FatJet_eta",             -2.4, 2.4, 12, 1,          "FatJet #eta",     "FatJet_eta",       -2.4,  2.4, 12, 1 },
 // { "FatJet_phi",             -3.4, 3.4, 12, 6,          "FatJet #phi",     "FatJet_phi",       -3.4,  3.4, 12, 1 },
 { "pTZ1",             0, 1000, 20, 1,          "Z1 p_{T} (GeV/c)",     "pTZ1",       0,  1000, 20, 1 },
//{ "pTZ2",             0, 1000, 20, 1,          "Z2 p_{T} (GeV/c)",     "pTZ2",       0,  1000, 20, 1 },
//{ "pTZ2_met",             0, 1000, 20, 1,          "Z2_met p_{T} (GeV/c)",     "pTZ2_met",       0,  1000, 20, 1 },
//{ "pTZ2_2j",             0, 1000, 20, 1,          "Z2_2j p_{T} (GeV/c)",     "pTZ2_2j",       0,  1000, 20, 1 },
// { "etaZ1",             -2.4, 2.4, 12, 1,          "Z1 #eta",     "etaZ1",       -2.4,  2.4, 12, 1 }, 
 //{ "etaZ2",             -2.4, 2.4, 12, 1,          "Z2 #eta",     "etaZ2",       -2.4,  2.4, 12, 1 },
//{ "etaZ2_2j",             -2.4, 2.4, 12, 1,          "Z2_2j #eta",     "etaZ2_2j",       -2.4,  2.4, 12, 1 },  
//{ "etaj2",             -2.4, 2.4, 12, 1,          "j2 #eta",     "etaj2",       -2.4,  2.4, 12, 1 },
// { "phiZ1",             -3.4, 3.4, 12, 6,          "Z1 #phi",     "phiZ1",       -3.4,  3.4, 12, 1 },
//  { "phiZ2_2j",             -3.4, 3.4, 12, 6,          "Z2_2j #phi",     "phiZ2_2j",       -3.4,  3.4, 12, 1 },
  //{ "phiZ2",             -3.4, 3.4, 12, 6,          "Z2 #phi",     "phiZ2",       -3.4,  3.4, 12, 1 },
 // { "phiZ2_met",             -3.4, 3.4, 12, 6,          "Z2 #phi",     "phiZ2_met",       -3.4,  3.4, 12, 1 },
 // { "phij2",             -3.4, 3.4, 12, 6,          "j2 #phi",     "phij2",       -3.4,  3.4, 12, 0 },
  // { "massZ1",             0, 200, 20, 1,          "massZ1 (GeV/C2)",     "massZ1",       0, 200, 20, 1 },
  // { "MET_pt",             0, 1000, 20, 1,          "MET_pt (GeV)",     "MET_pt",       0, 1000, 20, 1 },
 //  { "massZ2_2j",             0, 200, 20, 1,          "massZ2_2j (GeV/C2)",     "massZ2_2j",       0, 200, 20, 1 },
//   { "massZ2",             0, 200, 20, 1,          "massZ2 (GeV/C2)",     "massZ2",       0, 200, 20, 1 },
//    { "FatJet_mass",   0, 200, 20, 1, "FatJet_mass (GeV/c2)",               "FatJet_mass",    0.0, 200, 20, 1},
// ------------    LEPTONS  	-------------------
  
   //{"phiL2",          -4.5, 4.5, 8, 1,        "Lepton2 #phi",            "phiL2",    -4.5, 4.5,  8, 0 },
 // { "etaL2",          -2.5, 2.5, 8, 1,        "Lepton2 #eta",            "etaL2",    -2.5,  2.5,  8, 0 },
 //   { "etaL1",          -2.5, 2.5, 8, 1,        "Lepton1 #eta",            "etaL1",    -2.5,  2.5,  8, 0 },
 // { "pTL1",             0, 390, 26, 1,          "pTL1 (GeV/c)",     "pTL1",       0,  390, 26, 1 },
 //{ "Muon_eta",          -3.5, 3.5, 8, 1,        "Muon_eta #eta",            "Muon_eta",    -3.5,  3.5,  8, 0 },
//  { "pTL2",             0, 390, 26, 1,          "pTL2 (GeV/c)",     "pTL2",       0,  390, 26, 1 },
// { "nMuon",             0, 10, 10, 1,          "Number of muon",     "nMuon",       0,  10, 10, 1 },
